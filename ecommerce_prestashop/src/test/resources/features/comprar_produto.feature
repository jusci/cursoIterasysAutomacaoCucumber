...
Funcionalidade: Compar produto
  ...
  Esquema do Cenario: Deve mostrar produto escolhido confirmado
    ...
    Entao o produto aparece na confirmacao com nome <nomeProduto> e preco <precoProduto> tamanho <tamanhoProduto> cor <corProduto> e quantidade <quantidadeProduto>
