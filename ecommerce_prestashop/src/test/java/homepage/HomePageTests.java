...
// a partir do momento que crio uma variavel pro tipo da classe nao preciso instanciar um objeto
	...
	@CsvFileSource(resources = "/massaTeste_Login.csv", numLinesToSkip = 1, delimiter = ';') // pula a primeira linha do
																								// cabe�alho
